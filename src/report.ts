...
<footer><span class="privacy">Local-only · no telemetry · text excluded</span><p>Generated by agent-session-compare v0.1.2</p></footer></main><script type="application/json" id="comparison">${payload}</script></body></html>`;
}
